...
| 18 | Interviewer artifact upload fails with "new row violates row-level security policy" | Fixed via SQL | `process_artifacts` table was missing INSERT/SELECT/DELETE RLS policies. Added via Supabase SQL editor (migration #6 in SETUP.md) |
