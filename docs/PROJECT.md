...
| 18 | Interviewer artifact upload fails with "new row violates row-level security policy" | Requires SQL — see below | `process_artifacts` table missing INSERT/SELECT/DELETE RLS policies. Run migration #6 from SETUP.md in Supabase SQL editor |
