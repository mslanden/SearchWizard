...
| 26 | "Edit Candidate Profile" and "Edit Interviewer Profile" popups redundantly show artifacts table | Fixed in `133bd78` | Removed artifacts section (table + add button) and related state/handlers from `CandidateEditPopup`, `InterviewerEditPopup`, and `useCandidateEdit` hook; removed unused imports |
